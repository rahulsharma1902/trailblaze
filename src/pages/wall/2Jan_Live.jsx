...
Command: npx gltfjsx@6.5.3 public/models/1mondayafternoon.glb 
*/
...
export function Office(props) {
  ...
  const { nodes, materials } = useGLTF('./models/1mondayafternoon.glb')
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
            ...
            <group name="Object_2">
              <group name="RootNode">
                <group name="pac_man_machine" rotation={[-Math.PI / 2, 0, 0]}>
                  <mesh name="pac_man_machine_automat_0" geometry={nodes.pac_man_machine_automat_0.geometry} material={materials.automat} position={[12.547, -5.288, 0.493]} scale={[0.627, 1, 0.828]} />
                </group>
                <group name="scheibe" rotation={[-Math.PI / 2, 0, 0]}>
                  <mesh name="scheibe_scheibe_0" geometry={nodes.scheibe_scheibe_0.geometry} material={materials.scheibe} position={[12.547, -5.288, 0.493]} />
                </group>
              </group>
            </group>
          </group>
        ...
        <group name="world" position={[3335.908, 82.197, -255.886]} rotation={[1.188, -1.272, 1.203]} scale={213.195}>
          <mesh name="geometry_0" geometry={nodes.geometry_0.geometry} material={materials.Material_0} scale={[1, 0.986, 1]} />
        </group>
        <group name="world001" position={[2378.946, 78.186, -126.745]} rotation={[-3.134, 1.374, 3.134]} scale={276.247}>
          <mesh name="geometry_0001" geometry={nodes.geometry_0001.geometry} material={materials['Material_0.001']} position={[-0.009, -0.011, 0.022]} />
        </group>
        <group name="Sketchfab_model003" position={[4775.984, -65.132, -1841.825]} rotation={[-Math.PI / 2, 0, 0]} scale={[9.862, 8.02, 6.154]}>
          <group name="ad72bb6817744cbea1b39b136ec1313cfbx001" rotation={[Math.PI / 2, 0, 0]}>
            <group name="Object_2001">
              <group name="RootNode003">
                <group name="pac_man_machine001" rotation={[-Math.PI / 2, 0, 0]} />
                <group name="scheibe001" rotation={[-Math.PI / 2, 0, 0]} />
              </group>
            </group>
          </group>
        </group>
        <group name="Sketchfab_model004" position={[4574.795, -32.672, -1338.624]} rotation={[-1.543, -0.02, 0]} scale={[31.203, 30.25, 15.609]}>
          <group name="pinballMachineobjcleanermaterialmergergles001" />
        </group>
        <group name="world002" position={[-3806.044, 1393.905, -138.331]} rotation={[1.188, -1.272, 1.203]} scale={213.195}>
          <group name="geometry_0002" />
        </group>
        <group name="Plane002_SurfaceDrawing003" position={[1.571, -6.082, 6.201]} rotation={[Math.PI, 0, Math.PI]} scale={[0.395, 0.395, 0.418]} />
        ...
        <group name="FloorMirror" position={[3133.68, 0.821, 0]}>
          ...
          <mesh name="Tex_02_011002_1" geometry={nodes.Tex_02_011002_1.geometry} material={materials['Material.160']} />
        </group>
        ...
        <mesh name="Tex_02_004001" geometry={nodes.Tex_02_004001.geometry} material={materials['Tex_02.001']} position={[7071.491, -12.32, -652.565]} />
        <mesh name="Tex_02_013001" geometry={nodes.Tex_02_013001.geometry} material={materials['Tex_02.001']} position={[5118.79, 0.809, -943.769]} rotation={[0, 0.335, 0]} />
        <mesh name="Tex_02_019001" geometry={nodes.Tex_02_019001.geometry} material={materials['Tex_02.001']} position={[5120.63, 21.972, -940.533]} rotation={[0, 0.335, 0]} />
        <mesh name="Tex_02_003001" geometry={nodes.Tex_02_003001.geometry} material={materials['Tex_02.004']} position={[4880.16, 101.941, -849.575]} />
        <mesh name="Tex_02_003002" geometry={nodes.Tex_02_003002.geometry} material={materials['Tex_02.004']} position={[5287.329, 101.941, -849.575]} rotation={[Math.PI, -0.08, Math.PI]} />
        ...
        <mesh name="Main_Room001" geometry={nodes.Main_Room001.geometry} material={materials['Material.078']} position={[4760.83, -2.09, -4306.802]} scale={157.26} />
...
useGLTF.preload('./models/1mondayafternoon.glb')
