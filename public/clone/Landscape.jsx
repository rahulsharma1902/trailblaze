  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <PerspectiveCamera name="Camera_Web" makeDefault={false} far={10000} near={1} fov={22.895} position={[0, 272.206, 1862.464]} />
        <mesh name="desktop_arrow_button_main" geometry={nodes.desktop_arrow_button_main.geometry} material={nodes.desktop_arrow_button_main.material} position={[425.709, 148.449, 0.029]} />
        <mesh name="desktop_descriptor_title_text" geometry={nodes.desktop_descriptor_title_text.geometry} material={nodes.desktop_descriptor_title_text.material} position={[213.851, 148.449, 0.029]} />
        <mesh name="desktop_wow_title_sign" geometry={nodes.desktop_wow_title_sign.geometry} material={nodes.desktop_wow_title_sign.material} position={[-498.151, 411.845, 0.029]} />
        <mesh name="contact_form_fitback" geometry={nodes.contact_form_fitback.geometry} material={nodes.contact_form_fitback.material} position={[17355.436, 268.059, 0.029]} />
